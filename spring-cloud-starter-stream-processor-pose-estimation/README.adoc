...
*  `https://storage.googleapis.com/scdf-tensorflow-models/pose-estimation/2018-30-05-mobilenet_thin_graph_opt.pb` (default) - fast but less accurate
*  `https://storage.googleapis.com/scdf-tensorflow-models/pose-estimation/2018-05-14-cmu-graph_opt.pb` - accurate but slower
...
| pose-estimation --tensorflow.mode=header --tensorflow.model='https://storage.googleapis.com/scdf-tensorflow-models/pose-estimation/2018-05-14-cmu-graph_opt.pb'
