...
$$tensorflow.input-expression$$:: $$Specifies where the input data should comes from. Defaults to {@link org.springframework.messaging.Message}'s payload.$$ *($$String$$, default: `$$payload$$`)*
